...
В рамках подготовки на курсе "Аналитик данных (bootcamp)" Яндекс Практикума на реальных данных были подготовлены порядка 10 проектов.

Используемые инструменты: 
Python, PostgreSQL, Tableau, библиотеки: pandas matplotlib, NumPy SciPy, plotly, seaborn, SQLAlchemy, 

В рамках проектов сформированы следующие навыки:
...
|:-----:|-----|:-----:|-----|:-----:|:-----:|
|1|[Исследование надёжности заёмщиков](https://github.com/AVGorbulya/Yandex_Practicum/tree/main/1_Исследование надежности заемщиков)|Финансы|Определение зависимости возврата кредита в срок| `Python` `Pandas` |Завершен|
